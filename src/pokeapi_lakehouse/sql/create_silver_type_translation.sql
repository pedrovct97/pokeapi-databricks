CREATE TABLE IF NOT EXISTS {{table}} (
 ...
 source_observed_at TIMESTAMP NOT NULL COMMENT 'Observação da origem', silver_transformed_at TIMESTAMP NOT NULL COMMENT 'Transformação horário de Brasília (UTC-3)',
