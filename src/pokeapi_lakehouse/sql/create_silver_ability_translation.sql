CREATE TABLE IF NOT EXISTS {{table}} (
 ability_id BIGINT NOT NULL COMMENT 'Identificador da habilidade', language_id BIGINT NOT NULL COMMENT 'Identificador do idioma',
 ...
 silver_transformed_at TIMESTAMP NOT NULL COMMENT 'Transformação UTC', silver_run_id STRING NOT NULL COMMENT 'Execução Silver'
) USING DELTA COMMENT 'Textos localizados de habilidades; uma linha por habilidade e idioma'
